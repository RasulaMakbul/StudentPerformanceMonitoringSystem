            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form class="user" action="../php/add-user.php" method="POST" id="add-user-form">
                                ...
                                <div class="form-group row">
                                   <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="programID"
                                        placeholder="Program ID" required>
                                   </div>
                                   <div class="col-sm-6">
