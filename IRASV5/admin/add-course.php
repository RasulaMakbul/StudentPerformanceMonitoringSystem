...
<head>
    ...
    <title>IRAS V4 | Add Course</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">SPMV5</div>
            </a>
                            ...
                            <form class="course" action="../php/add-course.php" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-4 mb-4 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="programID" name="programID"
                                            placeholder="Program ID">
                                    </div>
                                    <div class="col-sm-4 mb-4 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="courseID" name="courseID"
                                            placeholder="Course ID">
                                    </div>
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="courseTitle" name="courseTitle"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control form-control-user"
                                            id="totalCO" name="totalCO" placeholder="Total CO">
                                    </div>
