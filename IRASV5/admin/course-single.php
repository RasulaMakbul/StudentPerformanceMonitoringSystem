...
<head>
    ...
    <title>IRAS V4 | Single Course</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Introduction to C Programming</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <h6>Course ID: CSE101</h6>
                            <h6>Course Title: Introduction to C Programming</h6>
                            <h6>Credit: 3.00</h6>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">PLO-CO Mapping</h6>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1" name="plo1-co" checked>
                                            </div>
                                        </td>
                                        <td align="center">
                                            <div class="form-check">
