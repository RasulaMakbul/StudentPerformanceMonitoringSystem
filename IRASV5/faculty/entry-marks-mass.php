...
<head>
    ...
    <title>IRAS V4 | All Mark Entry</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Faculty</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Entry Marks - Mass</h1>
                    <br>
                        ...
                        <div class="card-body">
                            <form class="marks" action="../php/add-marks-mass.php" enctype='multipart/form-data' method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control form-control-user" id="examName" name="examName"
